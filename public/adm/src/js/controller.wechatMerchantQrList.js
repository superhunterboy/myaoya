(function() {
    app.controller('wechatMerchantQrList',['$scope', '$rootScope', 'Table', 'http', 'ngDialog','Tip', function (s, rs, Table, http, ngDialog,tip) {
        s.table =Table.init({link: "/admin/merchants"});
        s.table.getList();
