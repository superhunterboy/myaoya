        ...
        function (s, rs, $filter, Table, http,tip) {
            ...
            function getUrl(frequency, compared){
                if(compared === "1day"){
                    ...
                    }else if(frequency === "20min"){
                        return "/data/getDatas/TwentyMinPayData"
                    ...
                    if(frequency === "5min"){
                        ...
                        return "/data/getDatas/TwoDayTwentyMinPayData"
                    }else if(frequency === "30min"){
                    ...
                    if(frequency === "5min"){
                        ...
                        return "/data/getDatas/ThreeDayTwentyMinPayData"
                    }else if(frequency === "30min"){
                    ...
                    if(frequency === "5min"){
                        ...
                        return "/data/getDatas/FiveDayTwentyMinPayData"
                    }else if(frequency === "30min"){
                    ...
                    if(frequency === "5min"){
                        ...
                        return "/data/getDatas/OneWeekTwentyMinPayData"
                    }else if(frequency === "30min"){
            ...
            var drawChart = function (dataList, frequency, compared) {
                ...
                if(frequency === "5min" || frequency === "10min" || frequency === "15min" || frequency === "20min"){
