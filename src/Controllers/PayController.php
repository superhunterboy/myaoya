...
class PayController extends BaseController
{
    ...
    public function queryPays(Request $request, Response $response, $args)
    {
        ...
        if (empty($down_excel)) {
            ...
            $vendor_types = [
                "雅付", "闪付", "讯宝", "乐盈", "自由付", "沃雷特", "金海哲", "华仁", "荷包", "立刻付", "多多", "金海哲(新)", "仁信", "天付宝", "高通",
                "新雅付", "先行付", "我付", "汇达", "泽圣", "新自由付", "钱袋支付", "金阳", "个人支付宝", "旺富通", "千应", "优付", "商码付", "恒辰",
                "成沃", "开联通", "点付云", "芯富", "滕坤", "天吉", "众点", "智能云支付", "智能云支付2.0", "喜付", "艾付", "Nong付", "顺心付", "米达",
                "wpay", "恒星闪付", "众信", "星捷", "迅捷", "云通", "闪亿", "恒通", "Bingopay", "乐享", "易宝","随意付","畅支付","银信","五福","Pppay","顺达通","盖亚","青英","极云","A付","AZ付"
            ];
            $payTypes = [
                '网银', '微信', '支付宝', 'QQ钱包', '京东钱包', '百度钱包', '银联钱包', '微信WAP', '支付宝WAP', 'QQWAP', '京东WAP', '百度WAP', '银联WAP',
            ];
