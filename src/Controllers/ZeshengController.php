...
class ZeshengController extends BaseController
{
    ...
    public function callback(Request $request, Response $response, $args)
    {
        ...
        */
        ...
        //日志
        $this->logger->addInfo('Zesheng payment callback data:', $returnData);
                        ...
                        if ($vendor && $company) {
                            ...
                            if ($pay_type == 20) {
                                ...
                                if ($verify) {
                                    ...
                                    $pay->vendor_order_no = $returnData['instructCode'];
                                    $pay->status          = $status;
    ...
    public function notify(Request $request, Response $response, $args)
    {
        ...
        */
        ...
        // 日志
        $this->logger->addInfo('Zesheng payment notify data:', $returnData);
