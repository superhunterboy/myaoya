...
class FhPay implements WMPay
{
     ...
     * @var string
     */
    public $getwayUrl = 'https://api.tfzf2.com/payCenter/aliPay2';
    ...
    public function signature($payType, $money, $orderId)
    {
        ...
        $this->params['partner']             =$this->parterNo;
        $this->params['amount']             =$this->money;
        $this->params['request_time']             =time();
        $this->params['trade_no']             =$this->orderNo;
        $this->params['pay_type']             =$payType;
    ...
    public function payment()
    {
        ...
        if($resArr['is_success'] == "T"){
            $data['is_success']=$resArr['is_success'];
            $data['result']=$resArr['result'];
            return json_encode($data);
        }else{
            $data['is_success']=$resArr['is_success'];
            $data['result']=$resArr['fail_msg'];
            return json_encode($data);
        }
    }
