...
class Jinhaizhe implements WMPay
{
    public $payType = [
        1 => [
            '100010' => '微信',
    ...
    {
        // 元宝业务号与默认的澳亚、葡京的不同，这里暂时这样区别
        if ($this->parterNo == 'zz1490681792629XQR42LI108') {
            $this->payType[1] = ['100012' => '微信'];
            $this->payType[2] = ['400012' => '支付宝'];
        }
        return $this->payType;
    }
    ...
    public function signature($type, $money, $orderId)
    {
        ...
        if (!in_array($type, ['100010', '400010', '100012', '400012'])) {
            $this->payCode                   = '1005';
            $this->params['payCode']         = $this->payCode;
            $this->params['cur']             = 'CNY';
    ...
    public function payment()
    {
        ...
        if ($res->getStatusCode() == '200') {
            ...
            // $this->logger->addInfo('Jinghaizhe QRcode data：', json_decode($resData, true));
